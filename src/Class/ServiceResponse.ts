...
import {ISession} from '../Dispatcher';
...
export class ServiceResponse<TBody>
{
    ...
    constructor(statusCode: number, headers: { [key: string]: string },
                body?: Readable | Readonly<ResponseBody<TBody>> | Readonly<TBody>, session?: Readonly<ISession>)
    {
